...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    accent: "#e11d48",
    secondary: "#fb7185",
    photo: "https://i.pravatar.cc/320?img=21",
  ...
  },
  {
    ...
    accent: "#7c3aed",
    secondary: "#a78bfa",
    photo: "https://i.pravatar.cc/320?img=31",
  ...
  },
  {
    ...
    accent: "#475569",
    secondary: "#94a3b8",
    photo: "https://i.pravatar.cc/320?img=35",
  ...
  },
  {
    ...
    accent: "#0ea5e9",
    secondary: "#7dd3fc",
    photo: "https://i.pravatar.cc/320?img=37",
  ...
  },
  {
    ...
    accent: "#84cc16",
    secondary: "#bef264",
    photo: "https://i.pravatar.cc/320?img=39",
    fullName: "Grant Walker",
    location: "Denver, CO",
    phone: "+1 (720) 555-0391",
    email: "grant.walker@proton.me",
    links: [
      "https://www.linkedin.com/in/grantwalker",
      "https://grantwalker.design",
    ],
    summary:
      "<p>Visual designer with 7 years crafting polished digital products for B2B and direct-to-consumer brands. I specialise in translating complex data into clear, engaging interfaces through thoughtful typography, colour, and motion. I bring a systematic approach to design that scales across platforms and teams.</p>",
    work: [
      {
        ...
        bullets: [
          "Owned the visual design language for a suite of 5 SaaS products, establishing colour, typography, iconography, and motion principles that unified the portfolio.",
          "Partnered with product designers and engineers to ship a design system with 120+ components, reducing UI implementation time by 35%.",
          "Led visual design for 3 major product launches, contributing to a 25% increase in trial-to-paid conversion across the suite.",
          "Mentored 2 junior designers through weekly critiques and structured skill-building sessions, both promoted within 18 months.",
        ],
      },
      {
        ...
        bullets: [
          "Designed responsive web and mobile interfaces for 15+ client projects across outdoor, wellness, and tech industries.",
          "Created data visualisation dashboards that transformed complex datasets into clear, actionable views for non-technical stakeholders.",
          "Developed a reusable component library in Figma that accelerated client project delivery by 20% and ensured visual consistency.",
        ],
      },
      {
        ...
        bullets: [
          "Produced visual assets for email campaigns, landing pages, and social media, maintaining brand consistency across 10+ client accounts.",
          "Assisted senior designers on branding projects, contributing to moodboards, style tiles, and visual explorations.",
        ],
      },
    ],
    skills: {
    ...
    projects: [
      {
        name: "SaaS Visual Language",
        start: "Feb 2023",
        end: "Oct 2023",
        bullets: [
          "Developed a comprehensive visual language system for a B2B SaaS suite, covering colour psychology, typography hierarchy, and motion guidelines.",
          "The system was adopted across 5 product teams, reducing design inconsistency tickets by 60% and improving brand perception scores by 18 points.",
        ],
      },
      {
        name: "Data Dashboard Redesign",
        start: "May 2022",
        end: "Dec 2022",
        bullets: [
          "Redesigned a analytics dashboard serving 10k+ users, transforming complex data into clear, scannable visualisations with custom chart components.",
          "The redesign reduced time-to-insight by 45% and received a Net Promoter Score of 72, up from 38 in user testing.",
        ],
      },
      {
        ...
        bullets: [
          "Designed and documented 120+ UI components in Figma with auto-layout tokens, variant properties, and usage guidelines for engineering handoff.",
          "The library reduced design-to-dev handoff time by 40% and was adopted as the company standard for all new product development.",
        ],
      },
    ],
    certs: [
      {
        name: "Data Visualisation Certificate",
        org: "Information is Beautiful Awards / IBM",
        date: "May 2022",
      },
      {
        name: "Advanced Figma Certification",
        org: "Figma Academy",
        date: "Jan 2022",
      },
      {
        name: "Motion Design for Interfaces",
        org: "School of Motion",
        date: "Aug 2021",
      },
    ],
    education: {
      ...
      degree: "B.F.A. in Graphic Design",
      gpa: "3.78 / 4.0",
      note: "Emphasis on digital media and typography; senior thesis on data visualisation aesthetics published in the university's design journal. Interned at a design studio where two projects shipped to national campaigns.",
    },
  },
  {
    ...
    accent: "#f97316",
    secondary: "#fdba74",
    photo: "https://i.pravatar.cc/320?img=43",
  ...
  // ── New templates: banner-alt ──────────────────────────────────────────────
  {
    ...
    accent: "#a21caf",
    secondary: "#e879f9",
    photo: "https://i.pravatar.cc/320?img=38",
  ...
  },
  {
    ...
    fullName: "Jesse Cooper",
    location: "Miami, FL",
    phone: "+1 (305) 555-0359",
    email: "jesse.cooper@fastmail.com",
    links: [
      "https://www.linkedin.com/in/jessecooper",
      "https://jessecooper.design",
    ],
    summary:
      "<p>UI/UX designer with 6 years designing consumer mobile apps and B2B web platforms. I combine a deep understanding of interaction design with a refined visual sensibility, creating interfaces that are both beautiful and intuitive. I advocate for inclusive design practices and data-informed iteration.</p>",
    work: [
      {
        company: "Wavelength Labs",
        position: "Senior UI/UX Designer",
        location: "Miami, FL",
        start: "Feb 2021",
        end: "current",
        bullets: [
          "Designed the consumer-facing mobile app for a music social platform, growing from concept to 250k MAUs through continuous UX research and iteration.",
          "Established a user-centred design process including weekly usability testing, design critique sessions, and a research repository that informed every sprint.",
          "Led the redesign of the onboarding flow, increasing 7-day retention from 38% to 56% through progressive disclosure and personalised recommendations.",
          "Mentored 2 product designers through formal growth plans, portfolio reviews, and cross-functional collaboration coaching.",
        ],
      },
      {
        ...
        bullets: [
          "Designed web and mobile interfaces for a real estate SaaS platform used by 5k+ agents, handling complex data tables, filtering, and map interactions.",
          "Conducted 40+ user interviews and usability tests that drove a restructuring of the property search flow, reducing time-to-contact by 32%.",
          "Built and maintained a component library in Figma with 80+ symbols and auto-layout components, ensuring consistency across a team of 5 designers.",
        ],
      },
      {
        company: "Tropic Design Studio",
        position: "Junior UI Designer",
        location: "Miami, FL",
        start: "May 2016",
        end: "May 2018",
        bullets: [
          "Designed responsive web interfaces for 10+ client projects across hospitality, real estate, and e-commerce.",
          "Produced interactive prototypes in Figma and Principle that were used to validate design decisions with stakeholders and users.",
        ],
      },
    ],
    skills: {
    ...
    projects: [
      {
        name: "Music Social App",
        start: "Mar 2023",
        end: "Feb 2024",
        bullets: [
          "Designed the end-to-end experience for a music social app, from onboarding and content discovery to social sharing and community features.",
          "Conducted 50+ user research sessions across 4 design sprints, iterating on the core feed and listening experience to achieve a 4.6-star App Store rating.",
        ],
      },
      {
        ...
        bullets: [
          "Redesigned the onboarding experience with progressive profiling and personalised content recommendations, lifting 7-day retention by 18 percentage points.",
          "Reduced onboarding drop-off by 42% through contextual tooltips, progress indicators, and a simplified permission flow.",
        ],
      },
      {
        ...
        bullets: [
          "Expanded the company's design system to cover mobile components, adding 40+ new components with interactive states, dark mode variants, and accessibility annotations.",
          "The expanded system reduced mobile UI development time by 30% and was adopted by the Android and iOS engineering teams.",
        ],
      },
      {
        ...
        bullets: [
          "Audited the entire product suite against WCAG 2.1 AA standards, identifying and prioritising 60+ accessibility improvements.",
          "Partnered with engineering to implement accessibility fixes across the platform, achieving WCAG AA certification within 5 months.",
        ],
      },
    ],
    certs: [
      { name: "Google UX Design Certificate", org: "Google", date: "Jul 2022" },
      {
      ...
      {
        name: "Interaction Design Specialisation",
    ...
    education: {
      ...
      degree: "B.F.A. in Interactive Media",
      gpa: "3.81 / 4.0",
      note: "Concentration in user experience design; senior capstone on inclusive design for aging populations was featured at the UM innovation showcase. Led the student design club for 2 years.",
    },
  },
  {
    templateId: "bold-type",
