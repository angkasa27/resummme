    ...
    >
      ...
      >
        <div className="grid gap-4 md:grid-cols-[88px_1fr]">
          ...
          >
            <FieldContent>
              <div className="flex flex-col items-start gap-2 ml-px">
                <button
                  type="button"
                ...
                <FieldError
                  errors={[getFieldState("photo", formState).error]}
                />
              </div>
            </FieldContent>
          </Field>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            >
              <FieldContent>
                ...
                />
                <FieldError
                  errors={[getFieldState("phone", formState).error]}
                />
              </FieldContent>
            </Field>
            ...
            >
              <FieldContent>
                ...
                />
                <FieldError
                  errors={[getFieldState("email", formState).error]}
                />
              </FieldContent>
            </Field>
          </div>
